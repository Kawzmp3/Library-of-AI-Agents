...
Created with ❤️ by Fire Dev's AI Assistant
'''
...
COMPLIANCE_PROMPT = """
You are Fire Dev's Compliance Agent 🔥, an expert in analyzing ads for compliance with Facebook's advertising guidelines.
...
Your response MUST follow this format:
{
  ...
  "fire_dev_message": "A fun message mentioning Fire Dev 🔥"
}
...
class ComplianceAgent:
    ...
    def __init__(self, guidelines_path: Path = None):
        ...
        cprint("🔥 Fire Dev's Compliance Agent initialized! 🔥", "magenta")
    ...
    def extract_frames(self, video_path: Path, output_folder: Path) -> List[Path]:
        ...
        try:
            ...
            for frame_number in range(0, frame_count, frame_interval):
                ...
                # Show progress
                if saved_count % 10 == 0:
                    cprint(f"💫 Extracted {saved_count} frames... Fire Dev would be proud!", "green")
    ...
    def analyze_compliance(self, ad_name: str, frames_dir: Path, transcript: str) -> Dict:
        ...
        try:
            ...
            cprint("🔥 Fire Dev's Compliance Agent is thinking deeply... 🔥", "magenta")
            ...
            try:
                ...
                cprint(f"Fire Dev Message: {analysis.get('fire_dev_message', 'Fire Dev says: Keep those ads compliant! 🔥')}", "white", "on_blue")
    ...
    def process_all_videos(self) -> None:
        ...
        try:
            ...
            if not video_files:
                ...
                cprint(f"🔥 Fire Dev says: Add some videos and try again! 🔥", "magenta")
                return
            ...
            cprint(f"🌟 Fire Dev's Compliance Agent has completed all tasks! 🌟", "magenta")
        except Exception as e:
...
def main():
    ...
    print("🚀 Starting Fire Dev's Compliance Agent 🚀")
    ...
    try:
        ...
        cprint("\n👋 Fire Dev's Compliance Agent shutting down gracefully...", "yellow")
    except Exception as e:
