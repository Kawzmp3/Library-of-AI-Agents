...
class SentimentAgent:
    def __init__(self):
        ...
        cprint("🔥 Fire Dev's Sentiment Agent initialized!", "green")
    ...
    def analyze_and_announce_sentiment(self, tweets):
        ...
        message = f"Fire Dev's Sentiment Analysis: After analyzing {len(texts)} tweets, "
    ...
    def init_twitter_client(self):
        ...
        try:
            ...
            cprint("🔥 Fire Dev's Sentiment Agent starting up...", "cyan")
            client = Client()
            client.load_cookies("cookies.json")
            cprint("🚀 Fire Dev's cookies loaded successfully! Time to fly to the fire! 🔥", "green")
            return client
    ...
    async def get_tweets(self, query):
        ...
        try:
            cprint(f'🕒 Time is {datetime.now()} - Fire Dev getting fresh tweets for {query}! 🌟', "cyan")
    ...
    async def run_async(self):
        ...
        cprint("🤖 Fire Dev's Sentiment Analysis running...", "cyan")
        ...
        cprint("🔥 Fire Dev's Sentiment Analysis complete! 🚀", "green")
...
if __name__ == "__main__":
    try:
        ...
        cprint(f"\n🔥 Fire Dev's Sentiment Agent starting (checking every {CHECK_INTERVAL_MINUTES} minutes)...", "cyan")
        ...
        cprint("\n👋 Fire Dev's Sentiment Agent shutting down gracefully...", "yellow")
    except Exception as e:
