...
class BookAgent:
    ...
    def __init__(self):
        ...
        cprint("🔥 Fire Dev's Book Agent Initializing...", "cyan")
    ...
    def ask(self, question: str) -> str:
        ...
        try:
            response = self.model.generate_response(
                system_prompt="You are Fire Dev's Knowledge Base AI 🔥. Answer questions based on the provided content only.",
                user_content=prompt,
                temperature=0.7
            )
...
def main():
    ...
    cprint("\n🔥 Fire Dev's Knowledge Base Assistant", "cyan")
    ...
    cprint("\n👋 Thanks for using Fire Dev's Knowledge Base Assistant! 🔥", "cyan")
